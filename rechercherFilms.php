<?php
    ...
    if (($vod = fopen("data/vod.csv", "r")) !== FALSE) {
        ...
        while (($data = fgetcsv($vod,":")) !== FALSE) {
            ...
            array_push($tmp, $nomFilms, $annee, $realisateur);
...
<?php
    ...
    if(isset($_POST['rechercherFilm'])){
        ...
        foreach($films as $unFilm){
            if(strtolower($rechercherFilm)  == strtolower($unFilm[0])){
               $filmTrouver = $unFilm;
                break;
            }
        ...
        <div class="column"></div>
          ...
          <div class="card-image">
            <figure class="image is-4by3">
              <img width="1280" height="960" src="style/images/<?php echo $filmTrouver[0].".jpg";?>" alt="<?php echo $filmTrouver[0].".jpg";?>">
            </figure>
          </div>
            ...
            <div class="media">
              <div class="media-left">
                <figure class="image is-48x48">
                  <img src="style/images/<?php echo str_replace('"', "",$filmTrouver[2]);?>.jpg" alt="<?php echo $filmTrouver[2];?>">
                </figure>
              </div>
              <div class="media-content">
                <p class="title is-4"><?php echo $filmTrouver[0];?></p>
                <p class="subtitle is-6"><?php echo  str_replace('"', "",$filmTrouver[2]);?></p>
              </div>
            </div>

            <div class="content">
              Vous pouvez nous trouver sur twitter <a>#<?php echo str_replace(" ","_",$filmTrouver[0]);?></a>.
              
              <br>
              <time datetime="2016-1-1"><h5><b><?php echo $filmTrouver[1];?></b></h5></time>
            </div>
          </div>
        </div>
        </div>
